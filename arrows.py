...
firstTime = 0
cloud7=pygame.transform.scale(pygame.image.load('files/cloud7.png'),(40,30))
cloud6=pygame.transform.scale(pygame.image.load('files/cloud6.png'),(90,48))
cloud5=pygame.transform.scale(pygame.image.load('files/cloud5.png'),(160,128))
cloud4=pygame.transform.scale(pygame.image.load('files/cloud4.png'),(400,138))
cloud3=pygame.transform.scale(pygame.image.load('files/cloud3.png'),(280,75))
cloud2=pygame.transform.scale(pygame.image.load('files/cloud2.png'), (310,130))
cloud1=pygame.transform.scale(pygame.image.load('files/cloud1.png'),(280,130))
bird = pygame.transform.scale(pygame.image.load('files/bird2.png'), (150, 150))
birdt=pygame.transform.scale(pygame.image.load('files/bird2t.png'), (150,150))
f1 = pygame.transform.scale(pygame.image.load('files/f1.png'), (150, 150))
f1t=pygame.transform.scale(pygame.image.load('files/f1t.png'),(150,150))
f2 = pygame.transform.scale(pygame.image.load('files/f2.png'), (150, 150))
f2t=pygame.transform.scale(pygame.image.load('files/f2t.png'), (150,150))
f3 = pygame.transform.scale(pygame.image.load('files/f3.png'), (150, 150))
f3t= pygame.transform.scale(pygame.image.load('files/f3t.png'),(150,150))
f4 = pygame.transform.scale(pygame.image.load('files/f4.png'), (150, 150))
f4t=pygame.transform.scale(pygame.image.load('files/f4t.png'),(150,150))
redArrow = pygame.transform.scale(pygame.image.load('files/redArrow.png'), (100, 140))
orangeArrow = pygame.transform.scale(pygame.image.load('files/orangeArrow.png'), (100, 140))
yellowArrow = pygame.transform.scale(pygame.image.load('files/yellowArrow.png'), (100, 140))
purpleArrow = pygame.transform.scale(pygame.image.load('files/purpleArrow.png'), (100, 140))
lightGreenArrow = pygame.transform.scale(pygame.image.load('files/lightGreenArrow.png'), (100, 140))
deepBlueArrow = pygame.transform.scale(pygame.image.load('files/deepBlueArrow.png'), (100, 140))
aquaArrow = pygame.transform.scale(pygame.image.load('files/aquaArrow.png'), (100, 140))
pinkArrow = pygame.transform.scale(pygame.image.load('files/pinkArrow.png'), (100, 140))
whiteArrow = pygame.transform.scale(pygame.image.load('files/whiteArrow.png'), (100, 140))
grayArrow = pygame.transform.scale(pygame.image.load('files/grayArrow.png'), (100, 140))
shield = pygame.transform.scale(pygame.image.load('files/shield.png'), (50, 50))
snail = pygame.transform.scale(pygame.image.load('files/snail.png'), (66, 48))
orange90 = pygame.transform.rotate(pygame.transform.scale(pygame.image.load('files/orangeArrow.png'), (100, 140)), 90)
orange_90 = pygame.transform.rotate(pygame.transform.scale(pygame.image.load('files/orangeArrow.png'), (100, 140)), -90)
portal = pygame.transform.scale(pygame.image.load('files/portal2.png'), (70, 70))
gift = pygame.transform.scale(pygame.image.load('files/gifteo.png'), (60, 60))
doublePoints = pygame.transform.scale(pygame.image.load('files/2x.png'), (40,40))
endless = pygame.transform.scale(pygame.image.load('files/endless.png'), (300, 155))
endlessLight = pygame.transform.scale(pygame.image.load('files/endlessLight.png'), (300, 155))
level = pygame.transform.scale(pygame.image.load('files/level.png'), (210, 155))
levelLight = pygame.transform.scale(pygame.image.load('files/levelLight.png'), (210, 155))
levelRed = pygame.transform.scale(pygame.image.load('files/levelRed.png'), (210, 155))
levelBlue = pygame.transform.scale(pygame.image.load('files/levelBlue.png'), (210, 155))
levelDarkBlue = pygame.transform.scale(pygame.image.load('files/levelDarkBlue.png'), (210, 155))
rules = pygame.transform.scale(pygame.image.load('files/rules.png'), (1280, 720))
invincSound = pygame.mixer.Sound('files/invincibilitySound.wav')
invincSound.set_volume(0.08)
deathSound = pygame.mixer.Sound('files/deathSound.wav')
deathSound.set_volume(0.15)
teleportSound = pygame.mixer.Sound('files/teleportSound.wav')
teleportSound.set_volume(0.35)
slowDownSound = pygame.mixer.Sound('files/slowdown.wav')
slowDownSound.set_volume(0.25)
speedUpSound = pygame.mixer.Sound('files/speedup.wav')
speedUpSound.set_volume(0.25)
powerupSound = pygame.mixer.Sound('files/powerup.wav')
powerupSound.set_volume(0.15)
doublePointsSound = pygame.mixer.Sound('files/doublePointsSound.wav')
doublePointsSound.set_volume(0.15)

legendary = pygame.mixer.Sound('files/legendary.ogg')
legendary.set_volume(0.03)
hope = pygame.mixer.Sound('files/hope.ogg')
hope.set_volume(0.03)
fire = pygame.mixer.Sound('files/fire.ogg')
fire.set_volume(0.03)
arrow = pygame.mixer.Sound('files/arrow.ogg')
arrow.set_volume(0.03)
firefly = pygame.mixer.Sound('files/firefly.ogg')
firefly.set_volume(0.03)
force = pygame.mixer.Sound('files/force.ogg')
...
def gameLoop():
    ...
    global bonus
    shield = pygame.transform.scale(pygame.image.load('files/shield.png'), (50, 50))
    snail = pygame.transform.scale(pygame.image.load('files/snail.png'), (82, 59))
    portal = pygame.transform.scale(pygame.image.load('files/portal2.png'), (70, 70))
    currentTime = pygame.time.get_ticks()
